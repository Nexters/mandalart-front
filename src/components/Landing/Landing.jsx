  ...
  <ReactFullpage
    ...
    render={({ state, fullpageApi }) => {
      return (
        ...
        >
            <div
                className="section landing-part1"
            >
            ...
            <div 
                className="section landing-part2" 
            >
                <div
                ...
                >
                    ...
                    <br />
                    <div>일본 디자이너 이마이즈미 히로아키가 개발한 발상기법입니다.</div>
                </div>
            </div>  

            <div 
                className="section landing-part3" 
            >   
                <div
                    className="image-wrapper"
                >
            ...
            <div 
                className="section landing-part4" 
            >
                <div
                    className="image-wrapper"
                >
            ...
            <div 
                className="section landing-part5" 
            >
                <div
                    className="landing-text"
                >            
            ...
            <div 
                className="section landing-part10" 
            >      
                <div
                    className="landing-text"
                >   
            ...
            <div 
                className="section landing-part11" 
            >
                <div
                    className="image-wrapper"
                >
                    <img src={success_block}/>   
                </div>
                <div
                    className="landing-text"
                >         
            ...
            <div 
                className="section landing-part12" 
            >
                <div
                    className="image-wrapper"
                >
